...
date: July 20, 2017
vignette: >
  %\VignetteIndexEntry{recount workshop: Learn to leverage 70,000 human RNA-seq samples for your projects}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8} 
bibliography: recount-workshop.bib
output: 
...
This workflow was created using `BiocStyle` [@BiocStyle].
